      ...
      if constexpr (D == Dim::_1D) {
        if constexpr (ExtCurrent) {
          ...
          const auto       ctx1 = ExtCurrentContext<D> {
            x1, i1, 0, 0, E, source_time, dx
          };
          const auto ctx23 = ExtCurrentContext<D> {
            x23, i1, 0, 0, E, source_time, dx
          };
    ...
    Inline void operator()(index_t i1, index_t i2) const {
      if constexpr (D == Dim::_2D) {
        if constexpr (ExtCurrent) {
          ...
          const auto       ctx1 = ExtCurrentContext<D> {
            x1, i1, i2, 0, E, source_time, dx
          };
          const auto ctx2 = ExtCurrentContext<D> {
            x2, i1, i2, 0, E, source_time, dx
          };
          const auto ctx3 = ExtCurrentContext<D> {
            x3, i1, i2, 0, E, source_time, dx
          };
      ...
      if constexpr (D == Dim::_3D) {
        if constexpr (ExtCurrent) {
          ...
          const coord_t<D> x3 { i1_ * dx + x1min,
                                ...
                                (i3_ + HALF) * dx + x3min };
          const auto       ctx1 = ExtCurrentContext<D> {
            x1, i1, i2, i3, E, source_time, dx
          };
          const auto ctx2 = ExtCurrentContext<D> {
            x2, i1, i2, i3, E, source_time, dx
          };
          const auto ctx3 = ExtCurrentContext<D> {
            x3, i1, i2, i3, E, source_time, dx
          };
